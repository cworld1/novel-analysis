...
class AnalAuthor:
    ...
    def draw_author_popularity_heatmap(self, analysis_data, context):
        ...
        for _, row in analysis_data.iterrows():
            ...
            heatmap_data.append([row["Name"], row["PreferredGenreStr"], popularity])
        heatmap = (
            HeatMap()
            ...
            .set_global_opts(
                visualmap_opts=opts.VisualMapOpts(
                    min_=min_popularity, max_=max_popularity
                ),
                title_opts=opts.TitleOpts(title=context["title"]),
...
# anal_author.anal(shape="heatmap").render("Author_popularity_heatmap.html")
